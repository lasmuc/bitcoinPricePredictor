...
support_vector_machine = SVC(kernel='rbf', C=1.0)
gradient_boosting = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1)
random_forest_classifier = RandomForestClassifier(n_estimators=100, random_state=42)
xgboost_classifier = xgb.XGBClassifier(n_estimators=100, learning_rate=0.1)

# Time-based cross-validation
n = len(btc_df_fng)
train_size = int(0.8 * n)  # Use 80% of the data for training

models = [logistic_regression, support_vector_machine, gradient_boosting, random_forest_classifier, xgboost_classifier]
model_names = ['Logistic Regression', 'SVM', 'Gradient Boosting', 'Random Forest Classifier', 'XGBoost']
